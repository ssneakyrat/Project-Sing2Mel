...
class ExpressiveControl(nn.Module):
    def __init__(self, input_dim=256, sample_rate=24000):
        ...
        # Expression parameter predictors - same as original
        ...
        # Tension-related spectral shaping parameters - same as original
    ...
    def forward(self, conditioning):
        """
        Predict expressive control parameters - simplified version
        ...
        """
        # Optimization 1: Compute all parameters in one step
        all_params = {}
        ...
        # Calculate tension-derived parameters
        all_params['tension_derived'] = self._calculate_tension_derived_params(all_params['tension'])
        
        return all_params
    
    def _calculate_tension_derived_params(self, tension):
        """Calculate derived parameters from tension - same as original"""
    ...
    def apply_vibrato(self, f0, time_idx, expressive_params):
        """
        Apply vibrato to F0 - optimized version with shape correction
        ...
        # Optimization: Combined calculation with proper broadcasting
        # Using proper dimensionality to avoid shape mismatches
    ...
    def process_audio(self, harmonic, noise, f0, time_idx, expressive_params):
        """
        Optimization 5: Combined processing pipeline for all audio effects
        with shape alignment handling
        ...
        synced_params['tension_derived'] = self._calculate_tension_derived_params(synced_params['tension'])
    ...
    def apply_combined_effects(self, harmonic, f0, expressive_params):
        """
        Optimization 1: Combined application of tension and vocal fry effects
        ...
        # Optimization 2: Vectorize attack processing
    ...
    def apply_breathiness(self, harmonic, noise, expressive_params):
        """
        Apply breathiness control - simplified but functionally the same
        ...
        # Mix harmonic and noise with breathiness control - direct operation
